...
TYPE_KPI = "2.125rem"            # base valores KPI (~34px)
TYPE_KPI_MONEY = "2.125rem"      # impacto financeiro
TYPE_KPI_IMPACTO = "2.125rem"    # R$ — legível sem dominar o card
TYPE_KPI_DEVOLUCOES = "2.375rem" # contagem — leve destaque vs impacto
TYPE_KPI_WIDE = "1.0625rem"      # principal motivo — abaixo dos números
...
KPI_VALUE_MIN_H_DEVOLUCOES = "40px"
KPI_VALUE_MIN_H_WIDE = "20px"
