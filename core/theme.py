...
TYPE_KPI = "2.5rem"              # base valores KPI
TYPE_KPI_MONEY = "2.5rem"        # impacto financeiro
TYPE_KPI_IMPACTO = "2.5rem"      # fixo — evita jump (antes 6rem)
TYPE_KPI_DEVOLUCOES = "2.875rem" # fixo — destaque numérico estável
TYPE_KPI_WIDE = "1.25rem"        # principal motivo — hierarchy refinada
...
KPI_VALUE_MIN_H_IMPACTO = "42px"
KPI_VALUE_MIN_H_DEVOLUCOES = "48px"
KPI_VALUE_MIN_H_WIDE = "22px"
